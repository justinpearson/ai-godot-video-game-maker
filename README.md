...
**To play:** Download the DMG, open it, drag the app out, then right-click > Open > Open (needed once for unsigned apps). Use **arrow keys** or **WASD** to move. Walk into the number that answers the addition problem at the top of the screen. macOS 10.12+, Apple Silicon or Intel.
