...
3. Remove the quarantine flag (required for unsigned apps downloaded from the internet):
   ```bash
   xattr -cr /path/to/MathAdventure.app
   ```
4. Double-click to launch. Use **arrow keys** or **WASD** to move. Walk into the number that answers the addition problem at the top of the screen.
